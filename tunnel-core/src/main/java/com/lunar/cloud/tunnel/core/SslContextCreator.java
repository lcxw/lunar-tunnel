...
public class SslContextCreator {
    ...
    public static SSLContext createSSLContext(InputStream storedJksInputStream, String keyStorePassword, String trustStorePassword) {
        return new SslContextCreator().initSSLContext(storedJksInputStream, keyStorePassword, trustStorePassword);
    }

    public SSLContext initSSLContext(InputStream storedJksInputStream, String keyStorePassword, String trustStorePassword) {
...
//            logger.info("Loading keystore. KeystorePath = {}.", jksPath);
            ...
            ks.load(storedJksInputStream, keyStorePassword.toCharArray());
